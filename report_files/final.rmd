...
header-includes:
    ...
    - \usepackage{float}
abstract: \singlespacing Report focuses on data gathered from exploratory analysis of 16S sequencing data gathered under Earth Microbiome Project (EMP). Data was gathered from locations all over world and by different research groups under various research papers. Data is contained in form of Operational Taxonomy Unit Table (OTU Table), which contains abundance profiles of chosen sties and from given sources. Exploratory analysis was focused on better understating  aforementioned data and drawing conclusions on its heterogeneous nature.
geometry: margin=1in
fontsize: 12pt
spacing: double
fig_caption: yes
...
# Bibliography  
Main article that was used in process of making this project was one by Mrs Calle, published in 2019 (first position in bibliography below)  
